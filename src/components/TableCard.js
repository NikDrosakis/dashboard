...
import Team1 from 'assets/img/user1.jpg';
import Team2 from 'assets/img/user2.jpg';
import Team3 from 'assets/img/user3.jpg';
import Team4 from '../assets/img/user4.jpg';
    ...
    return (
        <Card>
            <CardHeader color="purple" contentPosition="left">
                <h2 className="text-white text-2xl">{path}</h2>
            </CardHeader>
            <CardBody>
